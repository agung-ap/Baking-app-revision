package id.developer.agungaprian.bakingapprevisi2.model;
...
public class Recipes implements Parcelable {
    ...
    public String getServings() {
        String getServingData = servings.toString();
        return getServingData;
    }
    ...
    public static Creator<Recipes> getCREATOR() {
        return CREATOR;
    }
